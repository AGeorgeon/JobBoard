        	    ...
        	    <section id="grid">
        	      ...
        	      <div class="box">
        	        <div class="box-content box-info">
                      ...
                      <li class="collection-header">
        	              <h6>Birthday : {{ people.birthday  | dateParse('YYYY.MM.DD') | dateFormat('MM-YYYY') }}</h6>
                      </li>  
                      <li class="collection-header">
                      ...
                      <li class="collection-header">
        	              <h6>My candidacies : {{ people.candidacies }}</h6>
        	            </li>
                      <li class="collection-header">
        	              <h6>My company : {{ people.companies }}</h6>
        	            </li>
         	          </ul>
        	        </div>
        	      </div>
